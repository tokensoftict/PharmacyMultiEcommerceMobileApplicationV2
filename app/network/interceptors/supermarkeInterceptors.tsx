import { attachInterceptors, superMarketAxiosInstance } from '../internet';
...
superMarketAxiosInstance.interceptors.request.use(async function (request) {
    ...
    const userSession: UserProfile = authSession.getAuthSession();
...
attachInterceptors(superMarketAxiosInstance);
