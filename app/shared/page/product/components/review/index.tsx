...
import { likeReview, star, unlike } from "@/assets/icons";
    ...
    <View style={{marginBottom: normalize(24)}}>
      <View style={styles.header}>
        <View style={styles.row}>
          ...
          <View>
            <Typography style={styles.name}>Antony Lukas</Typography>
            <Typography style={styles.date}>2 days ago</Typography>
          </View>
        </View>
      ...
      <View style={styles.row}>
        <View style={styles.row}>
          ...
          <Typography style={styles.valueLike}>10k</Typography>
        </View>
        <View style={{width: 10}} />
        <View style={styles.row}>
          <Icon icon={unlike} />
          <Typography style={styles.valueLike}>500</Typography>
        </View>
      </View>
